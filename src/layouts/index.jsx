    ...
    return (
        <>
            <nav className="w-full navBar z-10 fixed top-0 flex flex-wrap justify-between items-center h-15 bg-gray-800 text-white">
                ...
                <div
                    className={active ? "pl-3.5 w-full md:h-max duration-300 items-center md:justify-between  overflow-hidden md:w-auto md:flex block md:flex-grow md:flex-row h-52" : "pl-3.5 w-full md:h-max h-0 duration-300 items-center md:justify-between  overflow-hidden md:w-auto md:flex block md:flex-grow md:flex-row"}>
